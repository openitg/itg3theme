function PlayerColor( pn )
	if pn == PLAYER_1 then return "#FFDE00" end	-- oranged yellow
	if pn == PLAYER_2 then return "#14FF00" end	-- green
	return "1,1,1,1"
end

function DiffusePlayerColor( pn )
	if pn == PLAYER_1 then return "diffuse,#FFDE00" end	-- oranged yellow
	if pn == PLAYER_2 then return "diffuse,#14FF00" end	-- green
	return "diffuse,1,1,1,1"
end
