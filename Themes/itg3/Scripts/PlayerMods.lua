...
function GetLifeBarEffectsP1()
	...
	-- Secret Area --
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('WinDEU Hates You The Movie/Secret Area'))
		then s = 'draworder,-1;rotationz,-90;addx,-100;sleep,0.5;decelerate,0.8;addx,100;sleep,83.8;accelerate,0.65;addy,-500;sleep,0.05;addy,1000;accelerate,0.45;addy,-1000;sleep,0.05;addy,1000;accelerate,0.25;addy,-1000;sleep,0.05;addy,1000;accelerate,0.2;addy,-1000;sleep,0.05;addy,1000;accelerate,0.15;addy,-800'; end

	-- Little Fragments of Silence --
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('WinDEU Hates You The Movie/Little Fragments of Silence'))
		then s = 'diffusealpha,1;draworder,-1;rotationz,-90;addx,-100;sleep,0.5;decelerate,0.8;addx,100;sleep,9.969;linear,0.068;zoomtowidth,0.5;addx,148;linear,0.137;zoomtowidth,1;addx,-148;linear,0.068;zoomtowidth,0.5;addx,148;linear,0.137;zoomtowidth,1;addx,-148;linear,0.068;zoomtowidth,0.5;addx,148;linear,0.137;zoomtowidth,1;addx,-148;linear,0.068;zoomtowidth,0.5;addx,148;linear,0.137;zoomtowidth,1;addx,-148;linear,0.068;zoomtowidth,0.5;addx,148;linear,0.137;zoomtowidth,1;addx,-148;sleep,1.159;linear,0.068;zoomtoheight,0.5;addy,-15;linear,0.137;zoomtoheight,1;addy,15;linear,0.068;zoomtoheight,0.5;addy,-15;linear,0.137;zoomtoheight,1;addy,15;linear,0.068;zoomtoheight,0.5;addy,-15;linear,0.137;zoomtoheight,1;addy,15;linear,0.068;zoomtoheight,0.5;addy,-15;linear,0.137;zoomtoheight,1;addy,15;linear,0.068;zoomtoheight,0.5;addy,-15;linear,0.137;zoomtoheight,1;addy,15;sleep,108.136;accelerate,2.2;zoomtowidth,0.25;addx,222;sleep,0.5;zoomtowidth,1;addx,-222;zoom,0;sleep,32.250;zoom,1'; end

	-- WinDEU Hates You Forever --

	-- Floating Darkness --
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('WinDEU Hates You Forever/Floating Darkness'))
		then s = 'draworder,-1;rotationz,-90;addx,-100;sleep,0.5;decelerate,0.8;addx,100'; end

	-- The Detonator --
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('WinDEU Hates You Forever/The Detonator'))
		then s = 'draworder,-1;rotationz,-90;addx,-100;sleep,0.5;decelerate,0.8;addx,100;sleep,135.203;linear,5;ZoomToHeight,10;addy,1250'; end
...
function GetScoreEffectsP1()
	...
	-- Secret Area --
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('WinDEU Hates You The Movie/Secret Area'))
		then s = 'addy,-100;sleep,0.5;decelerate,0.8;addy,100;sleep,83.3;accelerate,0.65;addy,-500;sleep,0.05;addy,1000;accelerate,0.45;addy,-1000;sleep,0.05;addy,1000;accelerate,0.25;addy,-1000;sleep,0.05;addy,1000;accelerate,0.2;addy,-1000;sleep,0.05;addy,1000;accelerate,0.15;addy,-800'; end

	-- Little Fragments of Silence --
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('WinDEU Hates You The Movie/Little Fragments of Silence'))
		then s = 'diffusealpha,1;addy,-100;sleep,0.5;decelerate,0.8;addy,100;sleep,9.969;linear,0.068;zoomtowidth,0.5;addx,90;linear,0.137;zoomtowidth,1;addx,-90;linear,0.068;zoomtowidth,0.5;addx,90;linear,0.137;zoomtowidth,1;addx,-90;linear,0.068;zoomtowidth,0.5;addx,90;linear,0.137;zoomtowidth,1;addx,-90;linear,0.068;zoomtowidth,0.5;addx,90;linear,0.137;zoomtowidth,1;addx,-90;linear,0.068;zoomtowidth,0.5;addx,90;linear,0.137;zoomtowidth,1;addx,-90;sleep,1.159;linear,0.068;zoomtoheight,0.5;addy,100;linear,0.137;zoomtoheight,1;addy,-100;linear,0.068;zoomtoheight,0.5;addy,100;linear,0.137;zoomtoheight,1;addy,-100;linear,0.068;zoomtoheight,0.5;addy,100;linear,0.137;zoomtoheight,1;addy,-100;linear,0.068;zoomtoheight,0.5;addy,100;linear,0.137;zoomtoheight,1;addy,-100;linear,0.068;zoomtoheight,0.5;addy,100;linear,0.137;zoomtoheight,1;addy,-100;sleep,108.136;accelerate,2.2;zoomtowidth,0.25;addx,135;sleep,0.5;zoomtowidth,1;addx,-135;zoom,0;sleep,32.250;zoom,1'; end

	-- Necrofantasia --
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('WinDEU Hates You The Movie/Necrofantasia'))
		then s = 'hidden,1'; end
	...
	-- The Detonator --
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('WinDEU Hates You Forever/The Detonator'))
		then s = 'addy,-100;sleep,0.5;decelerate,0.8;addy,100;sleep,135.203;linear,5;ZoomToHeight,10;addy,100'; end
		
	-- Lawn Wake XI --
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('WinDEU Hates You Forever/Lawn Wake XI'))
		then s = 'zoomy,0;sleep,4.85;zoomy,1;sleep,51.615;accelerate,1.2;addx,117;addy,120;zoom,0.35;linear,1.3;addx,130;addy,-65;linear,0.75;addx,-75;addy,-38;linear,1.82;addx,-182;addy,91;linear,2;addx,230;addy,115;linear,0.28;addx,28;addy,-14;linear,2.6;addx,-260;addy,-130;linear,1.24;addx,124;addy,-62;linear,1.36;addx,136;addy,68;linear,2.6;addx,-260;addy,130;linear,0.12;addx,16;addy,8;linear,2.44;addx,244;addy,-122;linear,1.68;addx,-168;addy,-84;linear,0.92;addx,-92;addy,46;linear,2.6;addx,260;addy,130;linear,0.6;addx,-60;addy,30;linear,2;addx,-200;addy,-100;linear,2.1;addx,210;addy,-105;linear,0.5;addx,50;addy,25;linear,2.6;addx,-260;addy,130;linear,1;addx,100;addy,50;linear,1.6;addx,160;addy,-80;linear,2.5;addx,-250;addy,-125;linear,0.1;addx,-10;addy,5;linear,2.6;addx,260;addy,130;linear,1.44;addx,-142;addy,71;linear,1.18;addx,-118;addy,-59;linear,2.6;addx,260;addy,-130;linear,0.36;addx,-36;addy,-18;linear,2.24;addx,-224;addy,112;linear,0.44;addx,44;addy,22;decelerate,1.2;zoom,1;x,SCREEN_CENTER_X-180;y,SCREEN_TOP+56;sleep,10.8;linear,1.8;ZoomX,0'; end

	-- SRT 8 --

	-- Weave Detonator --
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('SRT 8/Weave Detonator'))
		then s = 'hidden,1'; end
	...
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('WinDEU Hates You Infinity +1/Hard Weak Hard Magic'))
		then s = 'hidden,1'; end

	-- SRT 9 --

	-- Psy-Kaliber 2097 --
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('SRT 9/Psy-Kaliber 2097'))
		then s = 'hidden,1'; end
	...
	-- The End --
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('SRT X/The End'))
		then s = 'shadowlength,0;addy,-100;' .. DoublesScoreCenterP1() .. 'sleep,300;decelerate,0.8;addy,100'; end
...
function GetPlayerEffectsP1(pn)
	...
	if (GAMESTATE:IsPlayerEnabled(PLAYER_1) and not GAMESTATE:IsPlayerEnabled(PLAYER_2)) and (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('WinDEU Hates You The Musical/Nuclear Fusion'))
		then s = 'sleep,128.19;linear,1;x,SCREEN_CENTER_X;zoomx,0.5;sleep,44;linear,1;zoomx,1'; end

	-- WinDEU Hates You The Movie --

	-- Printer Jam --
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('WinDEU Hates You The Movie/Printer Jam'))
		then s = 'sleep,13.300;linear,0.69;addx,50;linear,0.69;addx,-100;linear,0.69;addx,100;linear,0.69;addx,-100;linear,0.258;addx,100;linear,0.258;addx,-100;linear,0.173;addx,100;linear,0.518;addx,-100;linear,0.862;addx,100;linear,0.69;addx,-100;linear,0.69;addx,100;linear,0.69;addx,-100;linear,0.69;addx,100;linear,0.69;addx,-100;linear,0.258;addx,100;linear,0.258;addx,-100;linear,0.173;addx,100;linear,0.518;addx,-100;linear,0.862;addx,100;linear,0.69;addx,-100;linear,0.69;addx,100;linear,0.69;addx,-100;linear,0.69;addx,100;linear,0.69;addx,-100;linear,0.258;addx,100;linear,0.258;addx,-100;linear,0.173;addx,100;linear,0.518;addx,-100;linear,0.862;addx,100;linear,0.345;addx,-50'; end

	-- Secret Area--
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('WinDEU Hates You The Movie/Secret Area'))
		then s = 'sleep,55.6;linear,0.2;rotationz,360;sleep,0.143;linear,0.3;rotationz,-360;sleep,1.714;queuecommand,Vibrate1;sleep,0.514;queuecommand,Stop;sleep,7.029;decelerate,0.65;rotationy,1080;sleep,19.357;accelerate,0.65;addy,-500;sleep,0.05;addy,1000;accelerate,0.45;addy,-1000;sleep,0.05;addy,1000;accelerate,0.25;addy,-1000;sleep,0.05;addy,1000;accelerate,0.2;addy,-1000;sleep,0.05;addy,1000;accelerate,0.15;addy,-800'; end

	-- Little Fragments of Silence --
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('WinDEU Hates You The Movie/Little Fragments of Silence'))
		then s = 'sleep,11.269;linear,0.068;zoomtowidth,0.5;addx,80;linear,0.137;zoomtowidth,1;addx,-80;linear,0.068;zoomtowidth,0.5;addx,80;linear,0.137;zoomtowidth,1;addx,-80;linear,0.068;zoomtowidth,0.5;addx,80;linear,0.137;zoomtowidth,1;addx,-80;linear,0.068;zoomtowidth,0.5;addx,80;linear,0.137;zoomtowidth,1;addx,-80;linear,0.068;zoomtowidth,0.5;addx,80;linear,0.137;zoomtowidth,1;addx,-80;sleep,1.159;linear,0.068;zoomtoheight,0.5;linear,0.137;zoomtoheight,1;linear,0.068;zoomtoheight,0.5;linear,0.137;zoomtoheight,1;linear,0.068;zoomtoheight,0.5;linear,0.137;zoomtoheight,1;linear,0.068;zoomtoheight,0.5;linear,0.137;zoomtoheight,1;linear,0.068;zoomtoheight,0.5;linear,0.137;zoomtoheight,1;sleep,108.136;accelerate,2.2;zoomtowidth,0.25;addx,120;sleep,0.5;zoomtowidth,1;addx,-120;sleep,51.572;queuecommand,Vibrate1;sleep,17.455;queuecommand,Stop;sleep,6.545;queuecommand,WagMovie;sleep,34.909;queuecommand,Stop'; end

	-- Necrofantasia --
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('WinDEU Hates You The Movie/Necrofantasia'))
		then s = 'queuecommand,NecrofantasiaPart1'; end
	...
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('WinDEU Hates You Infinity +1/Scarlet Heaven Of Delays'))
		then s = 'sleep,13.617;queuecommand,WagInfinity'; end
	...
	-- Psy-Kaliber 2097 --
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('SRT 9/Psy-Kaliber 2097'))
		then s = 'x,SCREEN_CENTER_X;queuecommand,ExtraQueue'; end
	
	-- SRT X

	-- The End --
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('SRT X/The End'))
		then s = 'sleep,350.594;queuecommand,PhantasmPartOneA'; end
	...
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('SRT 9/No 6'))
		then s = 'queuecommand,StageThreePartOne'; end

	-- SRT X --

	-- Hell Scaper --
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('SRT X/Hell Scaper (Last Escape Mix)'))
		then s = 'sleep,74.900;queuecommand,MidVibrate;linear,0.25;addy,640;queuecommand,Stop;sleep,5.083;linear,22.667;addy,-640'; end
...
function GetScoreEffectsP2()
	...
	-- The End --
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('SRT X/The End'))
		then s = 'shadowlength,0;addy,-100;' .. DoublesScoreCenterP2() ..'sleep,300;decelerate,0.8;addy,100'; end
...
function GetPlayerEffectsP2(pn)
	...
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('WinDEU Hates You The Movie/Necrofantasia'))
		...
		then s = 'queuecommand,NecrofantasiaPart1Offset'; else
		s = 'queuecommand,NecrofantasiaPart1'; end end
	...
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('WinDEU Hates You Forever/Floating Darkness'))
		then if GAMESTATE:IsPlayerEnabled(PLAYER_2) and GAMESTATE:IsPlayerEnabled(PLAYER_1)
		then s = 'x,SCREEN_CENTER_X+SCREEN_WIDTH*2;sleep,35.891;decelerate,0.659;addx,-180;sleep,1.978;decelerate,0.659;addx,360;sleep,1.319;decelerate,0.659;x,SCREEN_CENTER_X+SCREEN_WIDTH*2;sleep,17.143;decelerate,0.66;addx,-180;sleep,1.318;accelerate,1.319;addx,180;decelerate,1.319;addx,180;accelerate,1.319;addx,-180;decelerate,1.319;addx,-180;accelerate,1.319;addx,180;decelerate,1.319;addx,180;accelerate,1.319;addx,-180;decelerate,1.319;addx,-180;accelerate,1.319;addx,180;decelerate,1.319;addx,180;accelerate,1.319;addx,-180;decelerate,1.319;addx,-180;accelerate,0.659;addx,90;decelerate,0.659;addx,90;sleep,1.319;accelerate,3.956;rotationx,5400;decelerate,3.956;rotationx,10800'; else
		s = 'x,SCREEN_CENTER_X;sleep,35.891;decelerate,0.659;addx,-180;sleep,1.978;decelerate,0.659;addx,360;sleep,1.319;decelerate,0.659;x,SCREEN_CENTER_X;sleep,17.143;decelerate,0.66;addx,-180;sleep,1.318;accelerate,1.319;addx,180;decelerate,1.319;addx,180;accelerate,1.319;addx,-180;decelerate,1.319;addx,-180;accelerate,1.319;addx,180;decelerate,1.319;addx,180;accelerate,1.319;addx,-180;decelerate,1.319;addx,-180;accelerate,1.319;addx,180;decelerate,1.319;addx,180;accelerate,1.319;addx,-180;decelerate,1.319;addx,-180;accelerate,0.659;addx,90;decelerate,0.659;addx,90;sleep,1.319;accelerate,3.956;rotationx,5400;decelerate,3.956;rotationx,10800'; end end
	...
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('SRT 9/Psy-Kaliber 2097'))
		then if GAMESTATE:IsPlayerEnabled(PLAYER_2) and GAMESTATE:IsPlayerEnabled(PLAYER_1)
		then s = 'x,SCREEN_CENTER_X+SCREEN_WIDTH*2;queuecommand,ExtraQueueOffset'; else
		s = 'x,SCREEN_CENTER_X;queuecommand,ExtraQueue'; end end
	...
	if (GAMESTATE:GetCurrentSong() == SONGMAN:FindSong('SRT X/Anger of YuYu'))
		then if GAMESTATE:IsPlayerEnabled(PLAYER_2) and GAMESTATE:IsPlayerEnabled(PLAYER_1)
		then s = 'x,SCREEN_CENTER_X+SCREEN_WIDTH*2;sleep,56.152;queuecommand,LowVibrate;sleep,2.286;queuecommand,MidVibrate;sleep,9.142;queuecommand,HighVibrate;sleep,9.143;queuecommand,Stop;sleep,34.286;queuecommand,MidVibrate;decelerate,0.572;addx,-160;queuecommand,Stop;sleep,5.714-0.572;linear,1.143;addx,160;sleep,2.286;queuecommand,MidVibrate;decelerate,0.572;addx,160;queuecommand,Stop;sleep,5.714-0.572;linear,1.143;addx,-160'; else
		s = 'x,SCREEN_CENTER_X;sleep,56.152;queuecommand,LowVibrate;sleep,2.286;queuecommand,MidVibrate;sleep,9.142;queuecommand,HighVibrate;sleep,9.143;queuecommand,Stop;sleep,34.286;queuecommand,MidVibrate;decelerate,0.572;addx,-160;queuecommand,Stop;sleep,5.714-0.572;linear,1.143;addx,160;sleep,2.286;queuecommand,MidVibrate;decelerate,0.572;addx,160;queuecommand,Stop;sleep,5.714-0.572;linear,1.143;addx,-160'; end end
...
function HideFrame()
	...
	-- Floating Darkness --
	if GetCourseTitle() == 'Extra Stage (Forever)'
		then s = 'hidden,1'; end

	-- WinDEU Hates You Infinity + 1 --

	-- Model DD398 --
	if GetCourseTitle() == 'Extra Stage (Infinity)'
		then s = 'hidden,1'; end
	...
	-- Weave Detonator --
	if GetCourseTitle() == 'Phantasm'
		then s = 'hidden,1'; end

	-- SRT 9 --

	-- Psy-Kaliber 2097 --
	if GetCourseTitle() == 'Extra Stage (SRT 9)'
		then s = 'hidden,1'; end

	-- SRT X --
	
	-- The End --
	if GetCourseTitle() == 'The End'
		then s = 'addy,-300;sleep,300;decelerate,0.8;addy,300'; end
